...
While somewhat advanced, you can learn more about [changing the serialization here](/contract-interface/serialization-interface#overriding-serialization-protocol-default).
:::
